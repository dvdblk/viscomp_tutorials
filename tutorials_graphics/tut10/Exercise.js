...
function linearInterpolation(keyframes)
{
  ...
  return prevKeyframeVal + (normalizedTimeOffset * (nextKeyframeVal - prevKeyframeVal))
}
...
function cubicSplineInterpolation(keyframes)
{
  ...
  //return (1 - normalizedTimeOffset) * (nextKeyframeVal - prevKeyframeVal) / (nextTangent - prevTangent)
  t = normalizedTimeOffset;
  p0 = prevKeyframeVal;
  m0 = prevTangent;
  p1 = nextKeyframeVal;
  m1 = nextTangent;
